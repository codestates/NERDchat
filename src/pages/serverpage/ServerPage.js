...
import ServerPageCard from './ServerPageCard';
            ...
            <div className="game__list__card__container">
                {gameLists.map((list, idx) => {
                    ...
                    if(gameLists.length === idx+1){
                        return(<ServerPageCard ref={lastElementRef} key={list.id} id={list.id} category={list.category} img={list.image} like={list.fav}/>)
                    }
                    else {
                        return(<ServerPageCard key={list.id} id={list.id} category={list.category} img={list.image} like={list.fav}/>)
                    }
                })}
